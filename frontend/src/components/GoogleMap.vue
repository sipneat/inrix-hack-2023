<template>
  <div class="map">
    <GoogleMap api-key="AIzaSyBKpiq156O3XjKxdWvoEeSOWwqeX_ZNW5c" style="width: 585px; height: 960px; margin-left: 13%; padding-top: 23%; position: absolute;" :center="center" :zoom="15">
      <MarkerCluster>
